...
CREATE TABLE IF NOT EXISTS hubspot_contacts_logcomex (
    ...
    createdate VARCHAR(50), -- Max length observed: 24, Samples: 10
    email VARCHAR(72), -- Max length observed: 36, Samples: 8
    firstname VARCHAR(50), -- Max length observed: 9, Samples: 10
    hs_object_id INTEGER, -- Max length observed: 5, Samples: 10
    lastmodifieddate VARCHAR(50), -- Max length observed: 24, Samples: 10
    lastname VARCHAR(50), -- Max length observed: 14, Samples: 5
